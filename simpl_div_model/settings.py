"""
Django settings for simpl_div_model project.
...
SECRET_KEY = '4v6fmea4cx29x)vuc+*=mh)&q)%*w+4)r)0c!*))_o+3lzo(3$'
...
ROOT_URLCONF = 'simpl_div_model.urls'
...
WSGI_APPLICATION = 'simpl_div_model.wsgi.application'
